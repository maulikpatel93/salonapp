...
import { productDeleteApi, openProductDetailModal, productDetailApi, productDetailTab, productViewApi, productSortRemove } from "../../../store/slices/productSlice";
        ...
        Object.keys(objectData).map((item, i) => {
          ...
          return (
            <tr className="product-view-tr" key={i} data-id={id}>
              ...
              <td>
                <a className="cursor-pointer text-decoration-none hover-primary" onClick={handleProductDetailModal}>
                ...
                <div className="dropdown d-inline-block setting-dropdown">
                  ...
                  <div className="dropdown-menu dropdown-box dropdown-menu-end" aria-labelledby="dropdownMenuButton1" data-popper-placement="bottom-end">
                    <ul className="p-0 m-0 list-unstyled">
                      <li>
                        <a className="d-flex align-items-center edit-service cursor-pointer" onClick={(e) => handleProductDetailModal(e, { tab: "productdetail" })}>
